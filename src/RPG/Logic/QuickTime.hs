...
(quickTime, quickTimeAddr) = newMailbox $ fireball
(state, stateAddr) = unsafePerformIO $ mailbox 0
(startTime, startTimeAddr) = newMailbox 0
(stateTime, stateTimeAddr) = newMailbox 0
